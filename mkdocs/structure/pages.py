...
class Page:
    def __init__(self, title: str, file: File, config: Config) -> None:
        file.page = self
        self.file = file
        self.title = title
    ...
    def _set_canonical_url(self, base: str) -> None:
        if base:
    ...
    def _set_edit_url(self, repo_url: str, edit_uri: str) -> None:
